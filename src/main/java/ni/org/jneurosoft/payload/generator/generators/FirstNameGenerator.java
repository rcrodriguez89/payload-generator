...
public final class FirstNameGenerator implements ValueGenerator {

  @Override
  public String generate(JsonNode node, GenerationContext context, String path) {
    int idx = context.randomInt(0, RealisticData.FIRST_NAMES.size() - 1);
    String value = RealisticData.FIRST_NAMES.get(idx);
    context.putCurrentValue("firstName", value);
    return value;
  }
}
